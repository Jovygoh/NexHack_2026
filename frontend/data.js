...
const CONTRACTS = [
  {
    ...
    sections: [
      ...
      { title: '3. WORKING HOURS', clauses: [
        { id:'3.1', text:'The Employee shall work a minimum of 52 hours per week, Monday to Saturday, inclusive of a one-hour lunch break each day.', status:'bad', issue:'Exceeds maximum working hours', law:'Employment Act 1955 s.60A', desc:'Maximum working hours are 45 per week under s.60A. 52 hours is non-compliant.', suggestion:'Replace with: "The Employee shall work no more than 45 hours per week in accordance with Section 60A of the Employment Act 1955."' },
